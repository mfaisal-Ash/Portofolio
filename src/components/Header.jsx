...
<<<<<<< HEAD
                        <nav id="nav-menu" className={`${isOpen ? '' : 'hidden'} absolute py-4 top-full max-w-[250px] -right-5 bg-white shadow-lg rounded-lg w-full lg:block lg:static lg:bg-transparent lg:max-w-full lg:shadow-none lg:rounded-none dark:bg-dark dark:shadow-dark lg:dark:bg-transparent`}>
                            <ul className="block lg:flex">
                                ...
                                <li className="group"><a href="#about" onClick={toggleMenu} className="navbar-list group-hover:text-[#CCCCCC] dark:text-white">Tentang Saya</a></li>
                                <li className="group"><a href="#portfolio" onClick={toggleMenu} className="navbar-list group-hover:text-[#CCCCCC] dark:text-white">portfolio</a></li>
                                <li className="group"><a href="#experience" onClick={toggleMenu} className="navbar-list group-hover:text-[#CCCCCC] dark:text-white">Pengalaman</a></li>
                                <li className="group"><a href="#certificate" onClick={toggleMenu} className="navbar-list group-hover:text-[#CCCCCC] dark:text-white">Sertifikat</a></li>
                                <li className="group"><a href="#contact" onClick={toggleMenu} className="navbar-list group-hover:text-[#CCCCCC] dark:text-white">Kontak</a></li>
